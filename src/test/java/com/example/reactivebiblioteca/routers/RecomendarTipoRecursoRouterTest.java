...
@ContextConfiguration(classes = {RecomendarTipoRecursoRouter.class, RecomendarTipoRecursoUseCase.class, MapperUtils.class})

class RecomendarTipoRecursoRouterTest {
    @MockBean
    ...
    public void testRecomendarTipoRecurso() {
        ...
        webTestClient.get()
                .uri("/recursos/recomendar/tiporecurso/{tiporecurso}", "revista")
                .exchange()
                .expectStatus().isOk()
